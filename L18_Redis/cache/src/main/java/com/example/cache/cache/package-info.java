 ...
 *
 *
 *          Localized Cache vs Distributed
 *          (Ehcache)           (Redis)  --> it was running on different machine altogether with respect to spring boot application
 *          (redis)
 *
 *
 *
 *
 *              Server Instance  I1                         I2
 *              (Springboot application)                (SB application)
 *              redis                                   (redis)
 *
 *
 *
